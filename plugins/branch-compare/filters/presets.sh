...
get_filter_preset() {
  case "$1" in
    unity)  echo "-.git/;-*.csproj;-*.sln;-*.userprefs;-*.pidb;-*.unityproj;-.vs/;-*_DoNotShip/;-ExportedObj/;-.vscode/;-.idea/;-.utmp/;-.bezisidekick/;-Library/;-Temp/;-Logs/;-obj/;-Build/;-Builds/;-UserSettings/;-.gradle/;-.superpowers/;-.DS_Store;-mono_crash*" ;;
